...
public class BackgroundPlayerService implements Runnable {
	...
	public void run() {
		while (true) {
			...
			Color rightColor = new Color(image.getRGB(player.getX() + 40 + 10, player.getY() + 25));

			//Color boottomColor = new Color(image.getRGB(player.getX(), player.getY()));
			
			// 흰색이면 바닥의 RGB 값 → 255 255 255
